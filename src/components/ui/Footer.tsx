...
export default function Footer() {
  return (
    <footer
    className="relative border-t border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300 text-sm py-12 px-4"
    style={{
  ...
  >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-6 mb-6">
        ...
        <div className="flex flex-col items-start gap-2">
          <p className="text-sm text-neutral-500">Gaditas</p>
        ...
        {/* Copyright */}
        <div className="text-center md:text-center text-xs">
        ...
        <div className="flex flex-col items-end gap-2 text-right text-xs">
          <a href="/politica-de-privacidade" className="underline hover:text-white transition">
